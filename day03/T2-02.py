...
#T2-01 직접 제곱,  T2-02 PolynomialFeatures
...
# 평가
print(lr.score(test_poly, test_target)) # 0.9764933250721679
...
# 라쏘 회귀 : 서로 특성 간의 관계없는 특성들을 (0)제거 하는 목적
# 알파( alpth = 규제강도 )
